...
const DIALOGS: ILevelDialog[] = [
	{
		...
		answers: ['dellia', 'Dellia', 'deldel', 'Dellia Pilonika', 'Dellia', 'adek', 'lia', 'Lia'],
		hint: 'Need a clue (?) This game is made for my beloved girlfriend...'
	},
	{
		question:
			'Who is the best poop in the world?<br>' +
		...
		hint: '(?) Come on, just look at the bottom of the screen! or check your phone hehehe'
	},
	{
